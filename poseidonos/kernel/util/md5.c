...
static inline void Encode PROTO_LIST
  ((unsigned char *, UINT4 *, unsigned int));
static inline void Decode PROTO_LIST
  ((UINT4 *, unsigned char *, unsigned int));
static inline void MD5_memcpy PROTO_LIST ((POINTER, POINTER, unsigned int));
static inline void MD5_memset PROTO_LIST ((POINTER, int, unsigned int));
...
void md5_get_hash(char *digest, char *input)
{
  MD5_CTX context;
